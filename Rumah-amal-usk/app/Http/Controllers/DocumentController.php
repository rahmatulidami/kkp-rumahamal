...
class DocumentController extends Controller
{
    public function showDocuments()
    {
        ...
        while (true) {
            // Fetch data from API
            $response = Http::get("https://rumahamal.usk.ac.id/api-staging/wp-json/wp/v2/pages/4729?cp={$cp}");
            ...
            if ($response->ok()) {
                ...
                foreach ($links as $link) {
                    ...
                    if ($downloadUrl) {
                        ...
                        $iconUrl = "https://rumahamal.usk.ac.id/api-staging/wp-content/plugins/download-manager/assets/file-type-icons/{$fileType}.svg";
